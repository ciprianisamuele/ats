...
In R, \texttt{decompose()} uses classical moving-average filtering for the trend, whereas \texttt{stl()} uses LOESS. With \texttt{s.window="periodic"}, STL estimates one fixed seasonal pattern across cycles (equivalently, season-specific averages after detrending).
